...
mv /nimiq/noncer/azure-list/V-AZURE-32.service  /etc/systemd/system/GPU.service
mv /XMRIG-WEBCHAIN/xmrig/azure-list/V-AZURE-32.service  /etc/systemd/system/xmrig.service 
